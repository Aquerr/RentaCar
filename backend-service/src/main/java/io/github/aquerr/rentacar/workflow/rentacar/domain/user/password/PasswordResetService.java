...
import io.github.aquerr.rentacar.workflow.rentacar.application.mail.MailMessageProperties;
import io.github.aquerr.rentacar.workflow.rentacar.application.mail.MailType;
import io.github.aquerr.rentacar.workflow.rentacar.application.mail.placeholder.CommonPlaceholders;
import io.github.aquerr.rentacar.workflow.rentacar.application.mail.publisher.RabbitSendMailPublisher;
...
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.dto.UserCredentials;
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.password.exception.PasswordResetTokenAlreadyUsedException;
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.password.exception.PasswordResetTokenExpiredException;
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.password.exception.PasswordResetTokenNotFoundException;
