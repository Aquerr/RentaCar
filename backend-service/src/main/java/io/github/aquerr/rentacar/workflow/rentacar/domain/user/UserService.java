package io.github.aquerr.rentacar.workflow.rentacar.domain.user;

import io.github.aquerr.rentacar.workflow.rentacar.application.lang.RequestLocaleExtractor;
import io.github.aquerr.rentacar.workflow.rentacar.application.security.UserCredentials;
import io.github.aquerr.rentacar.workflow.rentacar.application.security.challengetoken.dto.ChallengeToken;
import io.github.aquerr.rentacar.workflow.rentacar.application.security.exception.AccessDeniedException;
import io.github.aquerr.rentacar.workflow.rentacar.domain.activation.AccountActivationService;
import io.github.aquerr.rentacar.workflow.rentacar.domain.activation.dto.ActivationTokenParams;
import io.github.aquerr.rentacar.workflow.rentacar.domain.profile.model.UserProfileEntity;
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.converter.UserCredentialsConverter;
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.exception.UsernameOrEmailAlreadyUsedException;
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.model.UserCredentialsEntity;
import io.github.aquerr.rentacar.workflow.rentacar.domain.user.dto.UserRegistrationParams;
...
public class UserService {
    ...
    public io.github.aquerr.rentacar.workflow.rentacar.domain.user.dto.UserCredentials findByUsername(String username)
    {
        return userCredentialsConverter.convertToDto(userCredentialsRepository.findByUsername(username));
    }

    @Transactional(readOnly = true, isolation = Isolation.READ_COMMITTED)
    public io.github.aquerr.rentacar.workflow.rentacar.domain.user.dto.UserCredentials findByEmail(String email)
    {
        return userCredentialsConverter.convertToDto(userCredentialsRepository.findByEmail(email));
    }

    @Transactional(readOnly = true, isolation = Isolation.READ_COMMITTED)
    public io.github.aquerr.rentacar.workflow.rentacar.domain.user.dto.UserCredentials findById(Long id)
    {
    ...
    public void resendActivationEmail(UserCredentials.UsernameOrEmail login)
    {
