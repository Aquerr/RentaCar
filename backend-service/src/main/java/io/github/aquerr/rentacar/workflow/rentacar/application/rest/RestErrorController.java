...
public class RestErrorController {
    ...
    public ResponseEntity<RestErrorResponse> handleException(HttpServletRequest httpServletRequest, RuntimeException exception) {
        ...
        if (exception instanceof AccessDeniedException)
            exception = new io.github.aquerr.rentacar.workflow.rentacar.application.security.exception.AccessDeniedException();
    ...
    {
        if (exception instanceof AccessDeniedException)
            return new io.github.aquerr.rentacar.workflow.rentacar.application.security.exception.AccessDeniedException();
