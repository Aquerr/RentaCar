...
public class UserService {
    ...
    public io.github.aquerr.rentacar.domain.user.dto.UserCredentials findByUsername(String username)
    {
        return userCredentialsConverter.convertToDto(userCredentialsRepository.findByUsername(username));
    }

    @Transactional(readOnly = true, isolation = Isolation.READ_COMMITTED)
    public io.github.aquerr.rentacar.domain.user.dto.UserCredentials findByEmail(String email)
    {
        return userCredentialsConverter.convertToDto(userCredentialsRepository.findByEmail(email));
    }

    @Transactional(readOnly = true, isolation = Isolation.READ_COMMITTED)
    public io.github.aquerr.rentacar.domain.user.dto.UserCredentials findById(Long id)
    {
